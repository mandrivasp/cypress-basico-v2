...
describe('Central de Atendimento ao Cliente TAT', function() {
  const THREE_SECONSDS_IN_MS = 3000
  ...
  it('exibe mensagem de erro quando o telefone se torna obrigatório mas não foi digitado', function() {
    cy.clock()
